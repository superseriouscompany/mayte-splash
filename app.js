...
function linkedinAuth() {
  ...
  var url = 'https://www.linkedin.com/uas/oauth2/authorization?client_id=' + clientId + '&response_type=code' + '&state=client.web' + '&scope=' + perms.join(' ').trim() + '&redirect_uri=' + redirectUrl;
